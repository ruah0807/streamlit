...
1. 연도 선택: 챗봇 시작 화면에서 원하는 연도를 선택합니다. 문서와 자료는 연도별로 정리되어 있어, 특정 시점의 정보를 쉽게 찾아볼 수 있습니다.\n

2. 질문 입력: 한국어로 질문을 입력하세요. 예를 들어 "2021년 해외사업 보고서 내용" 또는 "2023년 K-water의 주요 프로젝트"와 같이 연도와 주제를 포함한 질문을 입력하면, 챗봇이 해당 연도의 관련 문서를 우선적으로 검색합니다.

3. 결과 확인: 챗봇이 선택한 연도의 자료에서 가장 적합한 답변을 찾아 제공해줍니다. 추가적으로 더 많은 정보가 필요하면, 추가 질문을 통해 챗봇과 상호작용할 수 있습니다.
